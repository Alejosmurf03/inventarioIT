                ...
                <nav>
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                <li><a href="agregarMaterial.php">Agregar</a></li>
                        ...
                        <li class="submenu"><a href="#">Inventario<span class="icon-chevron-right"></span></a>
                            <ul>
                                <li><a href="inventarioDisponible.php">Disponible</a></li>
                                <li><a href="inventarioEnviado.php">Enviado</a></li>
                                <li><a href="inventarioEntregado.php">Entregado</a></li
                                <li><a href="inventarioPrestamo.php">Prestado</a></li>
                                <li><a href="inventarioMantenimiento.php">Mantenimiento</a></li>
                                <li><a href="inventarioEnvioBase.php">Envio a su base</a></li>
                                <li><a href="inventarioDisposal.php">Disposal</a></li>
                            </ul>
                        </li>
