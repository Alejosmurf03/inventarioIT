...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(95, 15, 'Tipo De Elemento', 1, 0, 'C', 0);
        $this->Cell(31, 15, 'Fecha', 1, 1, 'C', 0);
    }
...
$consulta = "SELECT material.cod_barras AS codigoBarras, "
        ...
        . "ON base.ID_base = material.ID_base WHERE material.estado='Activo' AND base.nombre = '$base' ";
...
if ($resultado->num_rows < 1) {
    ...
    while ($row = $resultado->fetch_assoc()) {
        ...
        $pdf->Cell(95, 10, $row['nombreTipo'], 1, 0, 'C', 0);
        $pdf->Cell(31, 10, $row['fecha'], 1, 1, 'C', 0);
    }
}
$pdf->Output();
?>