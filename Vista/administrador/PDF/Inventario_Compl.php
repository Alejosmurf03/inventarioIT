...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(32, 15, 'Base', 1, 0, 'C', 0);
        $this->Cell(32, 15, 'Estado', 1, 0, 'C', 0);
        $this->Cell(31, 15, 'Cantidad', 1, 1, 'C', 0);
    }
...
$consulta = "select tipo_material.nombre, material.ID_tipo,material.estado,"
        . "base.nombre As nombreBase, count(ID_tipo) as cantidadTipo "
...
if ($resultado->num_rows < 1) {
    ...
    while ($row = $resultado->fetch_assoc()) {
        ...
        $pdf->Cell(32, 10, $row['nombreBase'], 1, 0, 'C', 0);
        $pdf->Cell(32, 10, $row['estado'], 1, 0, 'C', 0);
        $pdf->Cell(31, 10, $row['cantidadTipo'], 1, 1, 'C', 0);
    }
}
$pdf->Output();
?>