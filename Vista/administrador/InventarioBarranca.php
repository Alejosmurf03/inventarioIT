    ...
    <body>
        ...
        <div class="contendorInventario">
            ...
            <div class="contenedorTabla">
                        ...
                        <div class="row">
                            <div class="table-responsive" id="tabla">
                                <table id="tabla1" name="tabla1" class="table table-striped table-bordered " style="width:100%;">
                                    ...
                                    <input type="hidden" name="txtBase" id="txtBase" value="Barranca">
                                    <thead id="thead">
                                        <tr>
                                            <td>Tipo Elemento</td>                            
                                            <td>Estado</td>
                ...
                <a href="../../Vista/administrador/PDF/Inventario_barranca.php" target="_blank" class="btn btn-danger">Generar Reporte</a>
            </div>
        </div>
